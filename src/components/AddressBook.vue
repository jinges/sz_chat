    ...
    <div class="addressBook">
        ...
        <svg style="display: none;">
            <symbol viewBox="0 0 1024 1024" id="groupListIcon">
                <path class="st0" d="M923.54,1024H100.46C44.98,1024,0,979.02,0,923.54V100.46C0,44.98,44.98,0,100.46,0h823.08
                C979.02,0,1024,44.98,1024,100.46v823.08C1024,979.02,979.02,1024,923.54,1024z" fill="#4DC669"/>
                <g>
                    <path class="st1" d="M699.08,669.54c-49.23-29.54-147.69-68.92-157.54-88.62c-5.84-11.68-4.75-37.16-2.89-56.01
                        ...
                        s-88.62,68.92-19.69,108.31h196.92h98.46h196.92C787.69,738.46,748.31,699.08,699.08,669.54z"  fill="#FFFFFF" />
                    <path class="st1" d="M789.4,614.29c-40.92-24.55-122.76-57.29-130.94-73.66c-4.85-9.71-3.95-30.89-2.41-46.55
                        ...
                        c49.23,29.54,103.79,55.25,118.15,88.93h23C863.05,671.58,830.32,638.84,789.4,614.29z" fill="#FFFFFF" />
                </g>
            </symbol>
            <symbol viewBox="0 0 1024 1024" id="newFriendIcon">
                <path class="st0" d="M923.54,1024H100.46C44.98,1024,0,979.02,0,923.54V100.46C0,44.98,44.98,0,100.46,0h823.08
                    C979.02,0,1024,44.98,1024,100.46v823.08C1024,979.02,979.02,1024,923.54,1024z"fill="#EE9C46" />
                <path class="st1" d="M728.97,521.69c-70.78,0-128.15,57.38-128.15,128.15S658.2,778,728.97,778s128.15-57.38,128.15-128.15
                    ...
                    c-3.28,12.24-5.19,25.03-5.19,38.3C581.1,704.7,611.05,752.48,655.41,778z" fill="#FFFFFF" />
            </symbol>
        </svg>
        <!-- 列表区 -->
        <div class="container">
            <vue-scroll style="width:100%">
                <template  v-for="topItem in topsData">
                    <AddressBookTop :toggleCls="true" v-bind="topItem" @selectFriend="selectFriend" @selectAddressBookTops="selectAddressBookTops"></AddressBookTop>
                </template>
