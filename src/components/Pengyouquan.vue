<template>
	<div class="pengyouquan">
		<div class="header">
			<font-awesome-icon icon="arrow-alt-circle-left" v-if="$store.state.currentPengyouquan" @click="back"></font-awesome-icon>
...
<script>
	...
	export default {
		...
		methods: {
			...
			onWsMsg(json) {
				if (json.commandName == 'SERVER_GET_MOMENT_LIST_ACK' ||
				...
				} else if (json.commandName == 'SERVER_LIKE_MOMENT_ACK' || json.commandName == 'SERVER_REPLY_MOMENT_ACK') {
